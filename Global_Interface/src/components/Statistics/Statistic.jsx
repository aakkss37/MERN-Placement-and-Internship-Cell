			...
			<ScrollTrigger onEnter={() => setAnimationOn(true)} onExit={() => setAnimationOn(false)}>
				<div className='statistic_counter'>
					<div className='counter_box'>
						{animationOn && <CountUp start={0} end={320} duration={4} useEasing={true} />}<span>+</span>
						<p>Companies Chose KAHE students</p>
					</div>
					<div className='counter_box'>
						{animationOn && <CountUp start={0} end={150} duration={4} useEasing={true} />}<span>+</span>
						<p>Companies offering CTC 5 Lacs p.a. or above</p>
					</div>
					<div className='counter_box'>
						{animationOn && <CountUp start={0} end={750} duration={4} useEasing={true} />}<span>+</span>
						<p>Numbar of Offers(p.a) for KAHE Students</p>
					</div>
					<div className='counter_box'>
						<span>₹</span>{animationOn && <CountUp start={0} end={34} duration={4} useEasing={true} />}
